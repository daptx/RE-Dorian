...
# get tweets about the colonial pipeline cyber attack from Texas, searched on May 10, 2021
pipeline = search_tweets("colonial pipeline OR cyberattack OR cybersecurity",
                       n=200000, include_rts=FALSE,
                       token=twitter_token, 
                       geocode="33.52,-86.81,1000mi",
                       retryonratelimit=TRUE) 

# write results of the original twitter search
write.table(pipeline$status_id,
            here("data","raw","public","pipelineids.txt"), 
...
pipelineids = 
  data.frame(read.table(here("data","raw","public","pipelineids.txt"), 
                        numerals = 'no.loss'))
...
pipeline_raw = rehydratoR("m4TwybVNDwtGC0kydCik3cW44", "QPQplWWUddibK7qWwd5C6ap2PHTrHpw20VKiVEp1caMw34H9lW", 
                          "1337140853652017152-kyr1fHph9e4UEhPIRcv6V7quRGaj63", 
                          "YS2gHHxp1JHiWuSeGEIuoHcX7AnX4HmVFx0EONzS1GV2C", pipelineids, 
